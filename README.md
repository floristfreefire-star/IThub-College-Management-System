...
**📧 Контакты:**
- Email: a.ivanov@ithub.ru
- Telegram: @alexey_ithub
- LinkedIn: [Профиль](#)

**💼 Навыки:**
`Project Management` `Agile/Scrum` `Документация` `Team Leadership`

**🏆 Статистика проекта:**
```mermaid
pie title Активность проекта
    "Завершено" : 45
    "В работе" : 30
    "В планах" : 25
```
...
`JavaScript` `React` `Node.js` `MongoDB` `Git` `Docker` `Figma`
